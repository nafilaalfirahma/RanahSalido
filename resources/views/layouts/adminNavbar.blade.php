...
>>>>>>> 6d1aacaeabe770f486de6dfd4773b63f7c5cc168
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="{{ route('pengelolaan_perkebunan.create') }}"><img src="{{ asset('assets/weed.png') }}"
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="{{ route('informasi_pasar.create') }}"><img src="{{ asset('assets/cart.png') }}" alt="Logo"
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                ...
                <b><img src="{{ asset('assets/contract.png') }}" alt="Logo" width="30" height="30"
                    class="d-inline-block align-text-bottom">Riwayat Pengajuan</b>
              </a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('pemesanan.indexAdmin') }}"><img src="{{ asset('assets/cart.png') }}" alt="Logo" width="25"
                      height="25" class="d-inline-block align-text-bottom"><b>Pengajuan Pemesanan</b></a></li>
                <li><a class="dropdown-item" href="formPengajuanKerjasama.php"><img src="{{ asset('assets/deal.png') }}" alt="Logo" width="30"
                      height="30" class="d-inline-block align-text-bottom"><b>Pengajuan Kerjasama</b></a></li>
              </ul>
            </li>
          </ul>
        </div>
