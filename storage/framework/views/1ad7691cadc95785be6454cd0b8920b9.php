...
<body>
    ...
    accessToken: 'pk.eyJ1IjoiYWJpemFyZGQiLCJhIjoiY2xxa2UxaTl0MXN1djJybW1yMWw5dzZzeiJ9.po1LGC3lGsMzjNxAjB9UaA'
        ...
        var markerLocations = [
        <?php $__currentLoopData = $marker; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        { coordinates: [<?php echo e($item->latitude); ?>, <?php echo e($item->longitude); ?>], popupContent:
                '<b>Lokasi:</b> <?php echo e($item->lokasi); ?><br>' +
                '<b>Sektor:</b> <?php echo e($item->sektor); ?><br>' +
                '<b>Jenis Bibit:</b> <?php echo e($item->jenis_bibit); ?><br>' +
                '<b>Jumlah Bibit:</b> <?php echo e($item->jumlah_bibit); ?><br>' +
                '<b>Luas Tanah:</b> <?php echo e($item->luas_tanah); ?>' },
...
</html><?php /**PATH C:\xampp\htdocs\RanahSalido\resources\views/peta_persebaran.blade.php ENDPATH**/ ?>